...
\begin{pspicture}(0,13.5)(\linewidth,0)
  ...
  \rput[l](0,-6.8){\textsl{\huge Utilities for R's Native C Interface}}
  \psline[linewidth=3mm,linecolor=black](0,-3)(\linewidth,-3)
  \psline[linewidth=3mm,linecolor=black](0,-6)(\linewidth,-6)
  \rput[b]{25}(12.2,-1.8){\includegraphics[scale=1.35]{realseamonster_small}}
  \rput[l](0,-4.5){\psscaleboxto(\textwidth,2){Guide to the RNACI Package}}
\end{pspicture}

\vfill\noindent
\ \hfill {\large\textsl{Drew Schmidt and Wei-Chen Chen}}
\end{document}
